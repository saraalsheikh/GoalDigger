...
CREATE TABLE `mood` (
  ...
  `user_mood` int DEFAULT NULL,
  `mood_date` date NOT NULL,
  PRIMARY KEY (`mood_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `mood_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`user_id`)
...
CREATE TABLE `to_do_list` (
  ...
  `plan_text` varchar(100) DEFAULT NULL,
  `plan_date` date NOT NULL,
  PRIMARY KEY (`plan_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `to_do_list_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_info` VALUES ('a','a','a');
...
-- Dump completed on 2024-05-30 19:36:48
